...
export default function StudentProgression({ student, classStudents, currentTerm }: Props) {
  const report = useMemo(
    () => generateProgressionReport(student, classStudents, currentTerm),
    [student, classStudents, currentTerm],
  );
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <span className="text-[11px] font-semibold px-3 py-1 rounded-full" style={{ background: '#f0f0ff', color: '#5556fd' }}>
          {discProfileLabels[report.disciplineProfile]}
        </span>
